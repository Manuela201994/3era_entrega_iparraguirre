...
urlpatterns = [
  ...
  #   path('inicio/adoptantes/', views.info_adoptantes, name='info_adoptantes'),
    path('inicio/adoptantes/', views.CreateView.as.view(), name='info_adoptantes'),
    ...
    path('inicio/modificar/<int:adoptante_id>', views.modificar_adoptantes, name='modificar_adoptante'),
]
